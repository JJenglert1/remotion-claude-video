...
```bash
npm i @remotion/transitions # If project uses npm
bun i @remotion/transitions # If project uses bun
yarn add @remotion/transitions # If project uses yarn
pnpm i @remotion/transitions # If project uses pnpm
```
